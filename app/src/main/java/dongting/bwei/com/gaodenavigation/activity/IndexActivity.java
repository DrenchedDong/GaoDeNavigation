...
import dongting.bwei.com.gaodenavigation.activity.custom.CustomUiActivity;
...
public class IndexActivity extends Activity {
    ...
    private String[] examples = new String[]
            ...
            {"驾车路线规划", "步行路线规划", "骑行路线规划 ( NEW!! )", "实时导航", "模拟导航", "智能巡航", "使用设备外GPS数据导航",
